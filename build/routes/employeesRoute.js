...
router.get('/:id', (req, resp, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const existingEmployee = yield employeesService_1.default.getInstance().findById(req.params.id);
        if (existingEmployee) {
...
router.put('/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield employeesService_1.default.getInstance().update(employeeId, Object.assign({}, req.body));
...
router.delete('/:id', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const employeeId = req.params.id;
        yield employeesService_1.default.getInstance().deleteByPrimaryKey(employeeId);
        res.status(200).json({
